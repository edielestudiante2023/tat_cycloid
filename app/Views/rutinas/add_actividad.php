...
<title>Nueva actividad — Rutinas</title>
...
<div class="container py-3 py-md-4" style="max-width:720px;">
    <div class="card card-rutinas">
        <div class="header-rutinas"><h1><i class="bi bi-plus-circle"></i> Nueva actividad</h1></div>
        <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?= base_url('rutinas/actividades/add') ?>" method="post">
                <div class="mb-3">
                    <label class="form-label">Nombre *</label>
                    <input name="nombre" class="form-control" required value="<?= esc(old('nombre')) ?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Descripción</label>
                    <textarea name="descripcion" class="form-control" rows="3"><?= esc(old('descripcion')) ?></textarea>
                </div>
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <select name="frecuencia" class="form-select" required>
                            ...
                            <option value="diaria">Diaria (incluye fin de semana)</option>
                        </select>
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label">Peso *</label>
                        <input name="peso" type="number" step="0.01" min="0" class="form-control" value="1.00" required>
                    </div>
                </div>
                <hr>
                <div class="d-flex gap-2 flex-wrap">
                    <button class="btn btn-cycloid"><i class="bi bi-check2"></i> Crear</button>
