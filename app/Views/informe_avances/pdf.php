...
<table class="header-table">
    ...
    <tr>
        <td class="header-title" style="font-size: 11px; color: #c9541a;">
            INFORME DE AVANCES
        </td>
        <td class="header-code">
            Pagina: 1 de 1
        ...
        <td style="border:1px solid #ddd; padding:8px;">
            ...
            <table style="width:100%"><tr>
                ...
                <td style="width:25%;border:none;padding:4px;text-align:center;">
                    <div style="font-size:26px;font-weight:bold;color:#c9541a;"><?= number_format($puntajeActual, 1) ?>%</div>
    ...
    <tr>
        <td style="border:1px solid #ddd; padding:8px;">
            ...
            <table style="width:100%"><tr>
                ...
                <td style="width:25%;border:none;padding:4px;text-align:center;">
                    <div style="font-size:26px;font-weight:bold;color:#c9541a;"><?= number_format($planPct, 1) ?>%</div>
        ...
        <td style="border:1px solid #ddd; padding:8px;">
            ...
            <table style="width:100%"><tr>
                ...
                <td style="width:25%;border:none;padding:4px;text-align:center;">
                    ...
                    ?>
                    <div style="font-size:26px;font-weight:bold;color:#c9541a;"><?= number_format($capPct, 1) ?>%</div>
        ...
        <td style="border:1px solid #ddd; padding:8px;">
            ...
            <table style="width:100%"><tr>
                ...
                <td style="width:25%;border:none;padding:4px;text-align:center;">
                    ...
                    ?>
                    <div style="font-size:26px;font-weight:bold;color:#c9541a;"><?= $abiertos ?> / <?= $totalPend ?></div>
