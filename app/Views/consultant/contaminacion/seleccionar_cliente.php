...
<head>
    ...
    <title>Contaminación Cruzada — Seleccionar Cliente</title>
    ...
    <style>
        ...
        .card-header-custom { background: linear-gradient(135deg,#dc3545,#e74c3c); color:#fff; padding:28px 32px; text-align:center; }
...
<body>
    <div class="container">
        <div class="main-card card">
            <div class="card-header-custom">
                <h2><i class="fas fa-exchange-alt me-2"></i> Contaminación Cruzada</h2>
    ...
    $(function() {
        ...
        $('#btnIr').on('click', function(){
            ...
            if (id) window.location.href = '<?= base_url('client/contaminacion/cliente') ?>/' + id;
        });
    });
    </script>
</body>
