...
<head>
    ...
    <title>Equipos y Utensilios — Seleccionar Cliente</title>
    ...
    <style>
        ...
        .card-header-custom { background: linear-gradient(135deg, #6c757d, #495057); color:#fff; padding:28px 32px; text-align:center; }
...
<body>
    <div class="container">
        <div class="main-card card">
            <div class="card-header-custom">
                <h2><i class="fas fa-tools me-2"></i> Equipos y Utensilios</h2>
                <p>Inspección semanal</p>
            </div>
    ...
    $(function() {
        ...
        $('#btnIr').on('click', function(){
            ...
            if (id) window.location.href = '<?= base_url('client/equipos/cliente') ?>/' + id;
        });
    });
    </script>
</body>
