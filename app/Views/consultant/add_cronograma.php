        ...
        <form action="<?= base_url('/addcronogCapacitacionPost') ?>" method="post">
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="perfil_de_asistentes" id="perfil_de_asistentes" class="form-control" value="TODOS" placeholder="Ej: TODOS, CONTRATISTAS, CLIENTES Y TRABAJADORES" required>
                </div>
            </div>
