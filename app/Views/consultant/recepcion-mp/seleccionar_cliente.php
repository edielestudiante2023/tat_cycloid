...
<head>
    ...
    <title>Recepción MP — Seleccionar Cliente</title>
    ...
    <style>
        ...
        .card-header-custom { background: linear-gradient(135deg, #6f4f28, #a8843f); color:#fff; padding:28px 32px; text-align:center; }
...
<body>
    <div class="container">
        <div class="main-card card">
            <div class="card-header-custom">
                <h2><i class="fas fa-truck-ramp-box me-2"></i> Recepción de Materias Primas</h2>
                <p>POES 4.1 — Control por cada entrega</p>
            </div>
    ...
    $(function() {
        ...
        $('#btnIr').on('click', function(){
            ...
            if (id) window.location.href = '<?= base_url('client/recepcion-mp/cliente') ?>/' + id;
        });
    });
    </script>
</body>
