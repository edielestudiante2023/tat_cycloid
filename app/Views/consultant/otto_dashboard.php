...
<head>
    ...
    <style>
        :root { --gold: #ee6c21; --gold-dark: #c9541a; }
        body { background: #f0f2f5; font-family: 'Segoe UI', sans-serif; }

        .topbar {
            background: linear-gradient(135deg, #c9541a, #2d3a52);
            color: white;
            padding: 14px 24px;
            display: flex;
            align-items: center;
        ...
        .kpi-card .kpi-value { font-size: 2.2rem; font-weight: 700; color: #c9541a; }
        ...
        .user-card .stat span:last-child { font-weight: 600; color: #c9541a; }
