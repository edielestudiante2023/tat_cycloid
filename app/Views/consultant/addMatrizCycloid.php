        ...
        <div class="container">
            <div class="row w-100 align-items-center">
                ...
                <div class="col-md-8 col-12 d-flex justify-content-between align-items-center">
                    <a href="https://tat.cycloidtalent.com/index.php/login" class="d-inline-block">
                        <img src="<?= base_url('uploads/tat.png') ?>" alt="Cycloid TAT Logo" class="img-fluid" style="max-height: 60px;">
                    </a>
                </div>
                <!-- Botón de Dashboard -->
