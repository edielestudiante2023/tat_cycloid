...
<head>
    ...
    <title>Permisos Bomberos — Seleccionar Cliente</title>
    ...
    <style>
        ...
        .card-header-custom { background: linear-gradient(135deg, #c9541a, #ee6c21); color: white; padding: 28px 32px; text-align: center; }
...
<body>
    <div class="container">
        <div class="main-card card">
            <div class="card-header-custom">
                <h2><i class="fas fa-fire-extinguisher me-2"></i>Permisos de Bomberos</h2>
                <p>Expediente anual por establecimiento</p>
            </div>
    ...
    $(function() {
        ...
        $('#btnIr').on('click', function() {
            ...
            if (id) window.location.href = '<?= base_url('client/bomberos/cliente') ?>/' + id;
        });
    });
    </script>
</body>
