...
<head>
    ...
    <title>Inspección de Aseo — Seleccionar Cliente</title>
    ...
    <style>
        ...
        .card-header-custom { background: linear-gradient(135deg, #198754, #20c997); color: white; padding: 28px 32px; text-align: center; }
...
<body>
    <div class="container">
        <div class="main-card card">
            <div class="card-header-custom">
                <h2><i class="fas fa-broom me-2"></i> Inspección de Aseo</h2>
                <p>Checklist de limpieza del local</p>
            </div>
    ...
    $(function() {
        ...
        $('#btnIr').on('click', function(){
            ...
            if (id) window.location.href = '<?= base_url('client/limpieza-local/cliente') ?>/' + id;
        });
    });
    </script>
</body>
