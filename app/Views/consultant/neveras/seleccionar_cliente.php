...
<head>
    ...
    <title>Control de Neveras — Seleccionar Cliente</title>
    ...
    <style>
        ...
        .card-header-custom { background: linear-gradient(135deg, #0277bd, #4facfe); color: white; padding: 28px 32px; text-align: center; }
...
<body>
    <div class="container">
        <div class="main-card card">
            <div class="card-header-custom">
                <h2><i class="fas fa-snowflake me-2"></i>Control de Neveras</h2>
                <p>Registros diarios de temperatura y humedad</p>
            </div>
    ...
    $(function() {
        ...
        $('#btnIr').on('click', function() {
            ...
            if (id) window.location.href = '<?= base_url('client/neveras/cliente') ?>/' + id;
        });
    });
    </script>
</body>
