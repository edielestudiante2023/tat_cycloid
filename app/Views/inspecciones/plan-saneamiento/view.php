...
<div class="d-grid gap-2 mb-4">
    ...
    <a href="<?= base_url('/inspecciones/plan-saneamiento/regenerar/') ?><?= $inspeccion['id'] ?>" class="btn btn-pwa btn-pwa-outline" onclick="return confirm('¿Regenerar el PDF con la plantilla actual?')">
        <i class="fas fa-sync-alt me-2"></i>Regenerar PDF
    </a>
    <a href="<?= base_url('/inspecciones/plan-saneamiento/enviar-email/') ?><?= $inspeccion['id'] ?>" class="btn btn-pwa btn-pwa-outline" onclick="return confirm('¿Enviar el PDF por email al cliente, consultor y consultor externo?')">
        <i class="fas fa-envelope me-2"></i>Enviar por Email
    </a>
    <?php endif; ?>
    <?php if ($inspeccion['estado'] === 'borrador'): ?>
    <a href="<?= base_url('/inspecciones/plan-saneamiento/edit/') ?><?= $inspeccion['id'] ?>" class="btn btn-pwa btn-pwa-outline">
        <i class="fas fa-edit me-2"></i>Editar
    </a>
    <?php endif; ?>
    <a href="<?= base_url('/inspecciones/plan-saneamiento') ?>" class="btn btn-pwa btn-pwa-outline">
