...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .header h1 { margin: 0; font-size: 16px; color: #bd9751; }
        ...
        .stats-bar span { font-weight: 700; color: #bd9751; }
        ...
        .item-body { flex: 1; }
        .item-numeral { font-size: 11px; color: #bd9751; font-weight: 700; margin-bottom: 2px; }
