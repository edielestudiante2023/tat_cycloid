...
<form method="post" action="<?= $action ?>" enctype="multipart/form-data" id="kpiResiduosForm">
    <?= csrf_field() ?>
    ...
    <div class="card mb-3">
        <div class="card-header bg-dark text-white py-2 px-3" style="font-size:13px;">
            <i class="fas fa-chart-bar me-1"></i> Indicador de Gestión
        </div>
        <div class="card-body p-3">
            <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================================
    const STORAGE_KEY = 'kpi_residuos_draft_<?= $inspeccion['id'] ?? 'new' ?>';
