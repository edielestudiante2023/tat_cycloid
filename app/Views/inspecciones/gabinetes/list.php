<?php $SLUG = 'gabinetes'; $TITULO = 'Gabinetes'; $ICONO = 'fa-shower'; ?>
<div class="container-fluid px-3 mt-2">
    ...
    <table id="tablaInsp" class="table table-sm table-hover" style="width:100%">
        <thead><tr><th>#</th><th>Cliente</th><th>Fecha</th><th>Estado</th><th>Gabinetes</th><th>Acciones</th></tr></thead>
        <tbody>
