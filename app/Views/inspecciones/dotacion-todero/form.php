...
<div class="container-fluid px-3">
    <form method="post" action="<?= $action ?>" enctype="multipart/form-data" id="dotTodForm">
        <?= csrf_field() ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================================
    const STORAGE_KEY = 'dot_tod_draft_<?= $inspeccion['id'] ?? 'new' ?>';
    ...
    function restoreFromLocal(data) {
        ...
        const keys = ['tapabocas','guantes_nitrilo','mascarilla_polvo','guantes_nylon','guantes_caucho','gafas','uniforme','sombrero','zapato','casco','careta','protector_auditivo','respirador','guantes_vaqueta','botas_dielectricas','delantal_pvc'];
        keys.forEach(k => {
