<?php $SLUG = 'reporte-capacitacion'; $TITULO = 'Reporte Capacitación'; $ICONO = 'fa-chalkboard-teacher'; ?>
<div class="container-fluid px-3 mt-2">
    ...
    <table id="tablaInsp" class="table table-sm table-hover" style="width:100%">
        <thead><tr><th>#</th><th>Cliente</th><th>Fecha</th><th>Capacitación</th><th>Estado</th><th>Acciones</th></tr></thead>
        <tbody>
        <?php foreach ($inspecciones as $i => $r):
            $f = $r['fecha_capacitacion'];
            $e = $r['estado'];
        ...
        <tr>
            ...
            <td><?= esc(mb_strimwidth($r['nombre_capacitacion']??'',0,40,'...')) ?></td>
