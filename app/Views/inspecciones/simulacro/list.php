<?php $SLUG = 'simulacro'; $TITULO = 'Simulacros'; $ICONO = 'fa-running'; ?>
<div class="container-fluid px-3 mt-2">
    ...
    <table id="tablaInsp" class="table table-sm table-hover" style="width:100%">
        <thead><tr><th>#</th><th>Cliente</th><th>Fecha</th><th>Evento</th><th>Estado</th><th>Acciones</th></tr></thead>
        <tbody>
        <?php foreach ($evaluaciones as $i => $r):
            $f = $r['fecha'];
            $e = $r['estado'];
