<?php $SLUG = 'botiquin-tipo-a'; $TITULO = 'Botiquín Tipo A'; $ICONO = 'fa-briefcase-medical'; ?>
<div class="container-fluid px-3 mt-2">
    ...
    <table id="tablaInsp" class="table table-sm table-hover" style="width:100%">
        <thead><tr><th>#</th><th>Cliente</th><th>Fecha</th><th>Estado</th><th>Ubicación</th><th>Acciones</th></tr></thead>
        <tbody>
        ...
        <tr>
            ...
            <td><?= esc($r['ubicacion_botiquin']??'') ?></td>
            <td>
