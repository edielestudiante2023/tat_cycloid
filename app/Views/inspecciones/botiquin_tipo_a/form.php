...
$action = $isEdit ? base_url('/inspecciones/botiquin-tipo-a/update/') . $inspeccion['id'] : base_url('/inspecciones/botiquin-tipo-a/store');
...
<div class="container-fluid px-3">
    <form method="post" action="<?= $action ?>" enctype="multipart/form-data" id="botForm">
        ...
        <div class="alert alert-info mt-2 mb-2" style="font-size:13px; padding:8px 12px;">
            <i class="fas fa-info-circle"></i> <strong>Botiquín Tipo A</strong> — Resolución 0705. Establecimientos comerciales con superficie menor a 2.000 m². Contiene 14 unidades.
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================================
    const STORAGE_KEY = 'bot_tipo_a_draft_<?= $inspeccion['id'] ?? 'new' ?>';
    ...
    initAutosave({
        formId: 'botForm',
        storeUrl: base_url('/inspecciones/botiquin-tipo-a/store'),
        updateUrlBase: base_url('/inspecciones/botiquin-tipo-a/update/'),
        editUrlBase: base_url('/inspecciones/botiquin-tipo-a/edit/'),
