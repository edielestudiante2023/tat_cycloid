<?php $SLUG = 'asistencia-induccion'; $TITULO = 'Asistencia Inducción'; $ICONO = 'fa-clipboard-list'; ?>
<div class="container-fluid px-3 mt-2">
    ...
    <table id="tablaInsp" class="table table-sm table-hover" style="width:100%">
        <thead><tr><th>#</th><th>Cliente</th><th>Fecha</th><th>Tipo Charla</th><th>Estado</th><th>Acciones</th></tr></thead>
        <tbody>
        <?php foreach ($inspecciones as $i => $r):
            ...
            $tipoLabel = $tiposCharla[$r['tipo_charla']??''] ?? esc($r['tipo_charla']??'');
        ?>
        <tr>
            <td><?= $i+1 ?></td>
