    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="row text-center g-0">
                ...
                <div class="col-3">
                    <div style="font-size:24px; font-weight:800; color:#ee6c21;"><?= number_format($promedio, 1) ?>%</div>
        ...
        <div class="card-body pb-2">
            ...
            <div class="d-flex justify-content-between align-items-start mb-2">
                ...
                <div class="text-end">
                    ...
                    <div style="font-size:15px; font-weight:800; color:#ee6c21; font-family:monospace;"><?= esc($s['codigo']) ?></div>
                </div>
            </div>
