<div class="page-header">
    <h1><i class="fas fa-recycle me-2"></i> Programa de Residuos Sólidos</h1>
    <a href="<?= base_url('client/inspecciones/residuos-solidos') ?>" class="btn-back">
...
<div class="card mb-3">
    <div class="card-body">
        ...
        <table class="table table-sm mb-0" style="font-size:14px;">
            ...
            <tr><td class="text-muted">Documento</td><td><span class="badge bg-dark">FT-SST-226</span></td></tr>
        </table>
    </div>
</div>
...
<div class="mb-4">
    ...
    <a href="<?= base_url('/inspecciones/residuos-solidos/pdf/') ?><?= $inspeccion['id'] ?>" class="btn btn-primary" target="_blank" style="background:#ee6c21; border-color:#ee6c21;">
