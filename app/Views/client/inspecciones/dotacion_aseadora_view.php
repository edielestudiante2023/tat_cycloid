...
<div class="mb-4">
    ...
    <a href="<?= base_url('/inspecciones/dotacion-aseadora/pdf/') ?><?= $inspeccion['id'] ?>" class="btn btn-primary" target="_blank" style="background:#ee6c21; border-color:#ee6c21;"><i class="fas fa-file-pdf"></i> Ver PDF</a>
    <?php endif; ?>
</div>
