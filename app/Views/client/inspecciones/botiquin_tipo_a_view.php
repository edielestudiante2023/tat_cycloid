...
function estadoColorClientTipoA(string $estado): string {
    $map = [
...
<div class="page-header">
    <h1><i class="fas fa-briefcase-medical me-2"></i> Inspección de Botiquín Tipo A</h1>
    <a href="<?= base_url('client/inspecciones/botiquin-tipo-a') ?>" class="btn-back">
...
<div class="card mb-3">
    <div class="card-body">
        ...
        <table class="table table-sm mb-0" style="font-size:14px;">
            ...
            <tr><td class="text-muted">Estado botiquín</td><td><strong class="<?= estadoColorClientTipoA($inspeccion['estado_botiquin'] ?? 'BUEN ESTADO') ?>"><?= esc($inspeccion['estado_botiquin'] ?? 'BUEN ESTADO') ?></strong></td></tr>
        </table>
    </div>
</div>
                ...
                <table class="table table-sm mb-0" style="font-size:12px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="<?= estadoColorClientTipoA($estado) ?>"><?= esc($estado) ?></span></td>
                            <?php if ($config['venc']): ?>
                            <td>
...
<div class="text-center mb-4">
    <a href="<?= base_url('/inspecciones/botiquin-tipo-a/pdf/') ?><?= $inspeccion['id'] ?>" class="btn btn-pdf" target="_blank">
