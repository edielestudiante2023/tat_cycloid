...
<div class="page-header">
    <h1><i class="fas fa-hard-hat me-2"></i> Dotación Todero</h1>
    <a href="<?= base_url('client/inspecciones/dotacion-todero') ?>" class="btn-back">
...
<div class="mb-4">
    ...
    <a href="<?= base_url('/inspecciones/dotacion-todero/pdf/') ?><?= $inspeccion['id'] ?>" class="btn btn-primary" target="_blank" style="background:#bd9751; border-color:#bd9751;"><i class="fas fa-file-pdf"></i> Ver PDF</a>
    <?php endif; ?>
</div>
