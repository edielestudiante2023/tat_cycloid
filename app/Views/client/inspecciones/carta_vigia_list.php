        ...
        <div class="card h-100" style="border-left:4px solid #28a745;">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <strong style="font-size:14px; color:#c9541a;">
                ...
                <div style="font-size:13px; color:#555;">
                    <div><i class="fas fa-id-card me-1" style="color:#ee6c21;"></i> CC <?= esc($carta['documento_vigia']) ?></div>
                    <div><i class="fas fa-envelope me-1" style="color:#ee6c21;"></i> <?= esc($carta['email_vigia']) ?></div>
                    <?php if (!empty($carta['telefono_vigia'])): ?>
                    <div><i class="fas fa-phone me-1" style="color:#ee6c21;"></i> <?= esc($carta['telefono_vigia']) ?></div>
                    <?php endif; ?>
                </div>
                ...
                <div class="mt-3 text-end">
                    <a href="<?= base_url('/inspecciones/carta-vigia/pdf/') ?><?= $carta['id'] ?>" target="_blank"
                       style="font-size:12px; color:#ee6c21; font-weight:600; text-decoration:none;">
