...
<div class="page-header">
    <h1><i class="fas fa-clipboard-check me-2"></i> Almacenamiento</h1>
...
echo view('client/inspecciones/layout', ['title' => 'Almacenamiento · ' . date('d/m/Y', strtotime($header['fecha_hora'])), 'content' => $content]);