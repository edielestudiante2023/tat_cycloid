...
<div class="page-header">
    <h1><i class="fas fa-boxes-stacked me-2"></i> Almacenamiento</h1>
    <a href="<?= base_url('client/almacenamiento/nueva') ?>" class="btn-back" style="background:rgba(255,255,255,.25);">
...
<?php if (empty($inspecciones)): ?>
    <div class="card p-4 text-center">
        <i class="fas fa-boxes-stacked" style="font-size:48px; color:#ccc;"></i>
        <h5 class="mt-3 text-muted">Sin inspecciones aún</h5>
        <p class="text-muted">Registra la primera inspección POES 4.4 de almacenamiento.</p>
        <a href="<?= base_url('client/almacenamiento/nueva') ?>" class="btn mt-2" style="background:#ee6c21; color:#fff;">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-1">
                        <a href="<?= base_url('client/almacenamiento/' . $i['id'] . '/ver') ?>"
                           class="btn btn-sm btn-outline-primary" style="border-color:#ee6c21; color:#ee6c21;">
                            <i class="fas fa-eye me-1"></i> Ver
                        </a>
                        <button type="button" class="btn btn-sm btn-outline-danger"
                                data-anular-url="<?= base_url('client/almacenamiento/' . $i['id'] . '/eliminar') ?>"
                                data-anular-titulo="Inspección de almacenamiento del <?= esc($i['fecha_hora'] ?? $i['creado_en'] ?? '') ?>">
...
echo view('client/inspecciones/layout', ['title' => 'Almacenamiento', 'content' => $content]);
