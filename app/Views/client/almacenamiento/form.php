...
<div class="page-header">
    <h1><i class="fas fa-boxes-stacked me-2"></i> Nueva inspección Almacenamiento</h1>
    <a href="<?= base_url('client/almacenamiento') ?>" class="btn-back">
...
<form id="formAlmacenamiento" action="<?= base_url('client/almacenamiento/guardar') ?>" method="post" enctype="multipart/form-data">
...
document.getElementById('formAlmacenamiento').addEventListener('submit', function(e) {
...
echo view('client/inspecciones/layout', ['title' => 'Nueva inspección Almacenamiento', 'content' => $content]);