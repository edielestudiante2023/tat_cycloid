...
<div class="page-header">
    <h1><i class="fas fa-clipboard-check me-2"></i> Inspección de aseo</h1>
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
            <div>
                ...
                <div class="text-muted small">
                    Registrado por: <?= esc(ucfirst($header['registrado_por'])) ?>
                </div>
            </div>
        </div>
...
<?php foreach ($detalles as $d):
    ...
    $badgeText = 'No aplica';
    if ($d['estado'] === 'limpio') { $borde = '#198754'; $badgeClass = 'bg-success'; $badgeText = 'Limpio'; }
    elseif ($d['estado'] === 'sucio') { $borde = '#dc3545'; $badgeClass = 'bg-danger'; $badgeText = 'Sucio'; }
?>
...
echo view('client/inspecciones/layout', [
    'title'   => 'Inspección de aseo · ' . date('d/m/Y', strtotime($header['fecha_hora'])),
    'content' => $content,
]);
