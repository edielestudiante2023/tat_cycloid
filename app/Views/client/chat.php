...
<body>
    ...
    <div class="chat-wrapper">
        ...
        <div class="chat-messages" id="chatMessages">
            <div class="welcome-message" id="welcomeMessage">
                ...
                <p>Soy Otto, tu asistente SST. Puedo consultarte el estado de seguridad y salud en el trabajo de <strong><?= esc($usuario['nombre_copropiedad'] ?: 'tu establecimiento comercial') ?></strong>. ¿En qué te ayudo hoy?</p>
    ...
    <a href="<?= base_url('client/dashboard') ?>" id="btnVolverDashboard" title="Volver al Dashboard" style="position:fixed;bottom:24px;left:24px;z-index:9998;width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#c9541a,#ee6c21);color:#fff;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 15px rgba(0,0,0,0.3);text-decoration:none;font-size:22px;transition:transform 0.2s,box-shadow 0.2s;border:2px solid rgba(255,255,255,0.2);">
