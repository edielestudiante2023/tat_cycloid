...
Fecha: <?= isset($latestVersion['sin_contrato']) && $latestVersion['sin_contrato'] ? '<span style="color: red; font-weight: bold;">PENDIENTE DE CONTRATO</span>' : strftime('%d de %B de %Y', strtotime($latestVersion['created_at'])); ?>
    ...
    <table>
        <!-- Título -->
        <tr>
            <th colspan="4" class="center">ACTA DE REUNIÓN COCOLAB #____________</th>
        </tr>
        <!-- Motivo, Horario, Lugar, Fecha -->
        <tr>
            <td colspan="2">Motivo: Reunión mensual COCOLAB</td>
            <td>Horario:</td>
            <td>Fecha:</td>
        </tr>
        <tr>
...
<footer>
    ...
    <!-- <div>
        <a href="<?= base_url('/generatePdf_actaCocolab') ?>" target="_blank">
