...
<body>
    ...
    <p>
        Estos programas incluyen una serie de normas o disposiciones, con el fin de mantener al establecimiento libre de posibles focos de contaminación, prevenir condiciones que pueden ser ofensivas a la población cliente o trabajador del establecimiento comercial y a sus contratistas, así como proporcionar espacios de trabajo y convivencia de manera limpia, saludable y segura, su acatamiento asegura una reducción en el riesgo de afectaciones a la salud, por ende, este plan de saneamiento básico ha sido diseñado y ejecutado para contribuir de manera significativa a mejorar la calidad de vida de los habitantes de <?= esc($client['nombre_cliente'] ?? '') ?>.
    </p>

    <h2>PLAN DE SANEAMIENTO</h2>
    <h3>INTRODUCCIÓN: PLAN DE SANEAMIENTO BÁSICO PARA <?= esc(strtoupper($client['nombre_cliente'] ?? '')) ?></h3>
    <p>
        La salud y el bienestar de los clientes y trabajadores en <?= esc($client['nombre_cliente'] ?? '') ?> dependen en gran medida de la calidad del entorno en el que viven. La adopción de un enfoque integral hacia la gestión y mantenimiento de las áreas del establecimiento es esencial para garantizar un ambiente limpio, seguro y saludable. Con el objetivo de salvaguardar la integridad sanitaria de nuestra comunidad y promover prácticas sostenibles, presentamos el "Plan de Saneamiento Básico para <?= esc($client['nombre_cliente'] ?? '') ?>".
    </p>
    <p>
    ...
    <p>
        La implementación de este plan no solo tiene como objetivo prevenir la propagación de enfermedades y garantizar la seguridad de nuestras instalaciones, sino también fortalecer el sentido de pertenencia y colaboración entre los clientes y trabajadores. Al abordar de manera proactiva los aspectos clave de saneamiento, estamos construyendo un ambiente propicio para el desarrollo integral y la calidad de vida de todos los habitantes de nuestra <?= esc($client['nombre_cliente'] ?? '') ?>.
    </p>
    <p>
        Este plan no es estático; evolucionará con las necesidades cambiantes de la comunidad y las actualizaciones normativas. Su éxito dependerá de la participación de cada cliente o trabajador y del compromiso continuo con las prácticas establecidas. A través de este documento, invitamos a todos los miembros de nuestra comunidad a unirse en la creación y mantenimiento de un entorno que refleje nuestro compromiso con la salud, la sostenibilidad y la convivencia armoniosa.
    </p>
    <p>
    ...
    <h3>OBJETIVOS DEL PLAN DE SANEAMIENTO BÁSICO PARA <?= esc(strtoupper($client['nombre_cliente'] ?? '')) ?></h3>
    <h4>OBJETIVO GENERAL:</h4>
    <p>
        Establecer un marco integral de saneamiento que garantice la salubridad, seguridad y calidad de vida en nuestra <?= esc($client['nombre_cliente'] ?? '') ?>, previniendo la propagación de enfermedades, protegiendo el medio ambiente y promoviendo una convivencia armoniosa.
    </p>

    <h4>OBJETIVOS ESPECÍFICOS:</h4>
    <ul>
        <li><strong>Mantenimiento de Áreas Comunes:</strong> Implementar procedimientos efectivos de limpieza y desinfección en áreas del establecimiento, asegurando un ambiente higiénico y seguro para todos los clientes y trabajadores.</li>
        ...
        <li><strong>Concientización y Participación Comunitaria:</strong> Fomentar la participación de los clientes y trabajadores mediante programas de educación sobre buenas prácticas de saneamiento, promoviendo la responsabilidad individual y colectiva.</li>
    ...
    <p>
        Este conjunto de objetivos refleja nuestro compromiso con la creación de un entorno seguro, limpio y sostenible. A través de la implementación de estos objetivos, aspiramos a fortalecer la calidad de vida de todos los clientes y trabajadores y a consolidar nuestra <?= esc($client['nombre_cliente'] ?? '') ?> como un espacio ejemplar en términos de saneamiento y convivencia comunitaria.
    </p>

    <h3>ALCANCE DEL PROGRAMA DE SANEAMIENTO BÁSICO PARA <?= esc(strtoupper($client['nombre_cliente'] ?? '')) ?></h3>
    <p>
        El alcance del programa abarca una serie de áreas y aspectos críticos en la <?= esc($client['nombre_cliente'] ?? '') ?>, con el propósito de asegurar un entorno saludable, seguro y sostenible para todos los clientes y trabajadores. Este programa engloba las siguientes dimensiones:
    </p>
    <ul>
        ...
        <li><strong>Concientización y Participación Comunitaria:</strong> Involucra actividades de educación y sensibilización para fomentar la participación de los clientes y trabajadores en la implementación y sostenibilidad de las prácticas de saneamiento.</li>
    ...
    <h2>GLOSARIO PARA EL PLAN DE SANEAMIENTO BÁSICO EN <?= esc(strtoupper($client['nombre_cliente'] ?? '')) ?></h2>
    <dl>
    ...
    <p>
        La colaboración de todos los clientes y trabajadores es esencial para el éxito de este programa. Invitamos a cada miembro de nuestra comunidad a comprometerse con la visión de un entorno más limpio, saludable y sostenible. Juntos, podemos construir un futuro donde el cuidado del medio ambiente sea parte integral de nuestro estilo de vida.
    </p>

    <h2>OBJETIVOS DEL PROGRAMA</h2>
    <h3>Objetivo General:</h3>
    <p>
        Implementar un Programa Integral de Manejo de Residuos en la <?= esc($client['nombre_cliente'] ?? '') ?> que cumpla con la legislación sanitaria vigente y promueva prácticas sostenibles, fomentando la participación de la comunidad para lograr una gestión eficiente y responsable de los residuos.
    </p>
    <h3>Objetivos Específicos:</h3>
    <ul>
        <li>Optimizar la Separación en la Fuente: Garantizar la correcta separación de los residuos en origen, promoviendo la conciencia ambiental entre los clientes y trabajadores.</li>
        ...
        <li>Promover la Educación Ambiental: Diseñar programas de educación ambiental dirigidos a los clientes y trabajadores, sensibilizando sobre la importancia del manejo adecuado de residuos.</li>
    </ul>



    <h1>ALCANCE</h1>
    <h2>ALCANCE DEL PROGRAMA INTEGRAL DE MANEJO DE RESIDUOS PARA LA <?= esc(strtoupper($client['nombre_cliente'] ?? '')) ?>:</h2>
    <p>
        El Programa Integral de Manejo de Residuos para la <?= esc($client['nombre_cliente'] ?? '') ?> abarcará todas las actividades relacionadas con la gestión de residuos sólidos en la comunidad, con el objetivo de cumplir con la legislación sanitaria vigente y promover prácticas ambientales sostenibles. El alcance del programa se detalla de la siguiente manera:
    </p>
    <ul>
        <li>
            <strong>Residuos Comunes:</strong> Incluye la implementación de estrategias para la separación en la fuente, recolección selectiva y disposición final adecuada de los residuos comunes generados por los clientes y trabajadores en la <?= esc($client['nombre_cliente'] ?? '') ?>.
        </li>
        <li>
        ...
        <li>
            <strong>Plan de Saneamiento Básico:</strong> Involucra la estructuración y ejecución de un Plan de Saneamiento Básico adaptado a las necesidades específicas de la <?= esc($client['nombre_cliente'] ?? '') ?>, incluyendo diagnósticos, metas, programas, participación comunitaria, infraestructura necesaria y mecanismos de seguimiento y evaluación.
        </li>
        <li>
            <strong>Capacitación y Educación Ambiental:</strong> Incorpora programas de capacitación y educación ambiental dirigidos a los clientes y trabajadores, con el propósito de promover la conciencia ambiental, la correcta separación de residuos, y el fomento de prácticas sostenibles en la <?= esc($client['nombre_cliente'] ?? '') ?>.
        </li>
        <li>
            <strong>Colaboración Comunitaria:</strong> Propone la activa participación y colaboración de todos los clientes y trabajadores, administradores y personal de la <?= esc($client['nombre_cliente'] ?? '') ?> en la ejecución de las estrategias del programa, buscando crear un compromiso colectivo para el cuidado del medio ambiente.
        </li>
    </ul>
    ...
    <h3>Objetivo General:</h3>
    <p>
        Implementar un programa de control de plagas en la <?= esc($client['nombre_cliente'] ?? '') ?> con el fin de salvaguardar la salud, el bienestar y la integridad de los clientes y trabajadores, promoviendo un entorno habitable libre de amenazas asociadas a la presencia de plagas.
    </p>
    <h3>Objetivos Específicos:</h3>
    <ul>
        ...
        <li><strong>Promoción de Prácticas Sostenibles:</strong> Fomentar entre los clientes y trabajadores prácticas cotidianas que contribuyan a la prevención de plagas, como el manejo adecuado de residuos sólidos, la limpieza constante y la eliminación de posibles criaderos. Se realizarán campañas de concientización y capacitación para garantizar la participación de la comunidad.</li>
        <li><strong>Colaboración Comunitaria:</strong> Establecer un canal efectivo de comunicación entre la administración y los clientes y trabajadores, promoviendo la colaboración y la retroalimentación. Se buscará la participación de la comunidad en la identificación de posibles problemas y en la implementación de soluciones, fortaleciendo así la responsabilidad compartida en el control de plagas.</li>
    ...
    <h2>ALCANCE</h2>
    <p>
        El programa de control de plagas en la <?= esc($client['nombre_cliente'] ?? '') ?> abarcará una serie de acciones y estrategias destinadas a garantizar un entorno residencial saludable, seguro y libre de amenazas asociadas a la presencia de plagas. El alcance del programa incluirá, pero no se limitará, a las siguientes áreas:
    </p>
    <ol>
        <li>
            ...
            <ul>
                ...
                <li>Implementación de medidas de control que minimicen el impacto ambiental y protejan la salud de los clientes y trabajadores.</li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                ...
                <li>Capacitación a los clientes y trabajadores sobre el manejo adecuado de residuos sólidos, la limpieza regular y la eliminación de posibles criaderos.</li>
            </ul>
        </li>
        <li>
            <strong>Colaboración Comunitaria:</strong>
            <ul>
                <li>Establecimiento de canales de comunicación efectivos para promover la colaboración entre la administración y los clientes y trabajadores.</li>
    ...
    <h2>INTRODUCCIÓN AL PROGRAMA DE ABASTECIMIENTO DE AGUA PARA LA <?= esc(strtoupper($client['nombre_cliente'] ?? '')) ?></h2>
    <p>
        La provisión sostenible y eficiente de agua es un pilar fundamental para el bienestar y la calidad de vida en nuestra comunidad de <?= esc($client['nombre_cliente'] ?? '') ?>. En este contexto, presentamos un programa integral de abastecimiento de agua diseñado para satisfacer las necesidades específicas de nuestros clientes y trabajadores, promoviendo un uso responsable y consciente de este recurso vital.
    </p>
    <p>
    ...
    <p>
        Además, reconocemos la importancia de la transparencia y la equidad en la gestión del agua. Por ello, incorporamos contadores individuales para cada local comercial, permitiendo una medición precisa del consumo y una distribución justa de costos.
    </p>
    <p>
        Este programa no solo busca establecer una infraestructura robusta y confiable, sino también fomentar una cultura comunitaria en la que todos los clientes y trabajadores participen activamente en la preservación de nuestro recurso hídrico. La educación sobre prácticas de uso eficiente, la detección temprana de posibles fugas y la colaboración en iniciativas de conservación son aspectos clave que promovemos.
    </p>
    <p>
    ...
    <p>
        A través de este programa de abastecimiento de agua, aspiramos a crear una comunidad responsable, consciente y resiliente, donde el acceso al agua sea confiable, equitativo y en armonía con el entorno. Invitamos a todos los clientes y trabajadores a participar activamente en este esfuerzo colectivo para preservar y mejorar nuestro entorno y calidad de vida.
    </p>

    <h2>OBJETIVO</h2>
    <h3>Objetivo General:</h3>
    <p>
        Garantizar un suministro continuo y una disponibilidad constante de agua para todos los clientes y trabajadores de la <?= esc($client['nombre_cliente'] ?? '') ?>, promoviendo un uso eficiente y consciente del recurso hídrico.
    </p>
    <h3>Objetivos Específicos:</h3>
    <ul>
        <li>
            ...
            <ul>
                <li>Fomentar prácticas de uso eficiente del agua entre los clientes y trabajadores mediante campañas educativas y materiales informativos.</li>
        ...
        <li>
            ...
            <ul>
                ...
                <li>Incentivar a los clientes y trabajadores a informar sobre fugas o irregularidades para una respuesta rápida y eficaz.</li>
            </ul>
        </li>
    </ul>
    ...
    <h2>ALCANCE</h2>
    <p>
        El programa se enfoca en establecer prácticas y medidas que aseguren un suministro constante de agua para todos los clientes y trabajadores de la <?= esc($client['nombre_cliente'] ?? '') ?>, sin incurrir en costos significativos o inversiones adicionales. Las acciones incluidas en el alcance se dividen en las siguientes áreas:
    </p>
    <ol>
        <li>
            <strong>Optimización del Uso del Agua:</strong>
            <ul>
                <li>Desarrollar campañas educativas para concientizar a los clientes y trabajadores sobre prácticas de uso eficiente del agua.</li>
                <li>Proporcionar materiales informativos y comunicados regulares que destaquen la importancia del ahorro de agua.</li>
                <li>Realizar inspecciones periódicas para identificar y reparar fugas menores en las áreas del establecimiento y en las locales comerciales.</li>
            </ul>
        </li>
        <li>
            <strong>Implementación de Medidas de Ahorro:</strong>
            <ul>
                <li>Instalar dispositivos de ahorro de agua, como grifos y cabezales de ducha de bajo flujo, en áreas del establecimiento y locales comerciales, promoviendo un consumo responsable.</li>
        ...
        <li>
            ...
            <ul>
                ...
                <li>Incentivar a los clientes y trabajadores a informar sobre posibles fugas o problemas en el suministro para una intervención rápida.</li>
        ...
        <li>
            ...
            <ul>
                <li>Fomentar la participación de los clientes y trabajadores a través de reuniones informativas y actividades comunitarias.</li>
    ...
    <p>
        La fuente de agua principal para la <?= esc($client['nombre_cliente'] ?? '') ?> es el acueducto de Bogotá, que se utiliza para todos los fines previstos. Es esencial destacar que, para aquellas actividades relacionadas con la limpieza, desinfección y procesamiento de alimentos que estén en contacto directo con los mismos, se utilizará exclusivamente agua potable. Esta medida garantiza la seguridad y la salud de los clientes y trabajadores, cumpliendo con los estándares establecidos para el uso adecuado del recurso hídrico.
    </p>
    ...
    <p>
        Este enfoque integral en la fuente de agua, tratamientos de potabilización y sistemas de almacenamiento busca no solo cumplir con los estándares regulatorios sino también garantizar un suministro confiable y seguro para todas las actividades dentro de la <?= esc($client['nombre_cliente'] ?? '') ?>.
    </p>
