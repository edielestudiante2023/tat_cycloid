...
$isEdit = !empty($item);
$action = $isEdit
    ? base_url('admin/equipos-items/' . $item['id_item'] . '/actualizar')
    : base_url('admin/equipos-items/guardar');
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title><?= $isEdit ? 'Editar item' : 'Nuevo item' ?> — Catálogo Equipos</title>
...
<div class="page-wrap">
    <div class="header-card mb-4">
        <h3 class="mb-0"><i class="fas fa-<?= $isEdit ? 'edit' : 'plus' ?> me-2"></i>
            <?= $isEdit ? 'Editar item' : 'Nuevo item de equipo/utensilio' ?>
        </h3>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descripcion" rows="2" class="form-control"
                                  placeholder="Criterios de revisión"><?= esc($item['descripcion'] ?? '') ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Icono Font Awesome</label>
                        <input type="text" name="icono" class="form-control"
                               placeholder="Ej: fa-blender, fa-fire-burner"
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="<?= base_url('admin/equipos-items') ?>" class="btn btn-outline-secondary">Cancelar</a>
                </div>
            </div>
        </div>
    </form>
