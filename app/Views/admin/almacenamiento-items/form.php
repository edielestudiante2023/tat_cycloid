...
$isEdit = !empty($item);
$action = $isEdit
    ? base_url('admin/almacenamiento-items/' . $item['id_item'] . '/actualizar')
    : base_url('admin/almacenamiento-items/guardar');
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title><?= $isEdit ? 'Editar' : 'Nuevo' ?> item — Items — Almacenamiento</title>
...
<div class="page-wrap">
    <div class="header-card mb-4">
        <h3 class="mb-0"><i class="fas <?= $isEdit ? 'fa-edit' : 'fa-plus' ?> me-2"></i>
            <?= $isEdit ? 'Editar' : 'Nuevo' ?> item — Almacenamiento
        </h3>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="<?= base_url('admin/almacenamiento-items') ?>" class="btn btn-outline-secondary">Cancelar</a>
                </div>
            </div>
        </div>
    </form>
