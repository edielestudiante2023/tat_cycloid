...
class InspeccionContaminacionDetalleModel extends Model
{
    protected $table         = 'tbl_inspeccion_contaminacion_detalle';
    ...
    {
        return $this->db->table('tbl_inspeccion_contaminacion_detalle d')
            ->select('d.*, i.nombre AS item_nombre, i.icono AS item_icono, i.orden AS item_orden')
            ->join('tbl_contaminacion_item i', 'i.id_item = d.id_item', 'left')
